...
class ScholarChangePasswordScreen extends StatefulWidget {
  const ScholarChangePasswordScreen({super.key});

  @override
  State<ScholarChangePasswordScreen> createState() => _ScholarChangePasswordScreenState();
}

class _ScholarChangePasswordScreenState extends State<ScholarChangePasswordScreen> {
